...
- **Acceptance** — numbered observable delivery outcomes with external
  pass/fail evidence acceptance testing can produce; no value claim, scenario, test step, UI placement,

...
# tests/loom-visualization/test_templates.py, plus modal softeners that
...
def test_negation_vocabulary_matches_sibling_gate():
    ...
    gate = Path(__file__).resolve().parents[1] / "loom-visualization" / "test_templates.py"
...
def _ascii_by_client():
    ...
    gate = PLUGIN_ROOT / "tests" / "loom-visualization" / "test_templates.py"

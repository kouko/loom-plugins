...
_SCRIPT = (
    pathlib.Path(__file__).resolve().parents[2] / "skills" / "loom-visualization" / "scripts" / "align.py"
)
...
_HERE = pathlib.Path(__file__).resolve().parents[2] / "skills" / "loom-visualization" / "scripts"

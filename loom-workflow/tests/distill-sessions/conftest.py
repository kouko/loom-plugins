...
The tests live in loom-workflow/tests/distill-sessions/, apart from the scripts
they import by bare module name, so the skill's scripts directory goes on
sys.path here.
"""
...
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "skills" / "distill-sessions" / "scripts"))

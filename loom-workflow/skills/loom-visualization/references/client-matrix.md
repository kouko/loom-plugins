...
|---|---|---|---|---|---|
| Claude Code CLI / JetBrains | `CLAUDECODE=1`, `CLAUDE_CODE_ENTRYPOINT=cli` | yes | no (source shown raw) | table + ASCII | https://code.claude.com/docs/en/env-vars, https://github.com/anthropics/claude-code/issues/14375 |
| Claude Code VS Code | `CLAUDECODE=1`, `CLAUDE_CODE_ENTRYPOINT` names the IDE extension | yes | no (source shown raw) | table + ASCII | https://code.claude.com/docs/en/env-vars, https://github.com/anthropics/claude-code/issues/20529 |
| Claude Desktop Code tab | `CLAUDECODE=1` | yes | no (source shown raw) | table + ASCII | https://code.claude.com/docs/en/env-vars, https://github.com/anthropics/claude-code/issues/52517 |
...
stay ASCII. A wrong Mermaid choice shows the user raw source; a table plus

...
directory; `${CLAUDE_PLUGIN_ROOT}` is this plugin's root, substituted on
Claude Code — on any other host it is the directory three levels above this
file, two above `SKILL.md`). It is not a restatement of the

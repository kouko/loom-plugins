...
expected = {'intent': 'intent', 'intents': 'intents', 'intake': 'intake', 'push': 'push', 'publish': 'publish', 'land': 'land', 'sync-trunk': 'sync', 'github-rules': 'github_rules', 'pr-floor': 'pr_floor', 'standing': 'standing', 'contract': 'contract', 'charter': 'charter', 'plan': 'plan', 'reviewer-count': 'reviewer_count', 'finalize-review': 'finalize', 'selection': 'selection'}

...
- **Codex CLI commands** — examples show Claude Code's tool surface (`Skill(...)`, `Bash(...)`, etc.). The same flow works on Codex CLI via `/skill-name` slash commands per the `using-loom-code` skill.
...
- [`../../skills/using-loom-code/SKILL.md`](../../skills/using-loom-code/SKILL.md) — router charter (Stage 0 always-on)

...
(the closing-review fix-round working tree on top of 12d15b38) with the same
...
|---|---|---|
| code | `tests loom-code/tests` (xdist) | 2333 passed, 2 skipped |
...
Totals: pytest 3631 passed, 6 skipped (code 2333/2, design 245/1,
...
|---|---|---|---|
| code | 2271 passed, 2 skipped | 2333 passed, 2 skipped | +62 passed |
| design | 245 passed, 1 skipped | 245 passed, 1 skipped | 0 |
| workflow-python | 1052 passed, 3 skipped | 1053 passed, 3 skipped | +1 passed |
| pytest total | 3568 passed, 6 skipped | 3631 passed, 6 skipped | +63 passed |
...
63 tests are new, and each one is listed here.
...
Reconciliation: code 23 probes + 5 + 6 + 28 = 62; design 0; workflow 1;
62 + 0 + 1 = 63 = 3631 − 3568. The 24 tests the baseline recorded as never

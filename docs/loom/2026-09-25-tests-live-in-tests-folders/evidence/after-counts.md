...
(the closing-review fix-round working tree on top of 277a1c0f) with the same
...
|---|---|---|
| code | `tests loom-code/tests` (xdist) | 2335 passed, 2 skipped |
...
Totals: pytest 3633 passed, 6 skipped (code 2335/2, design 245/1,
...
|---|---|---|---|
| code | 2271 passed, 2 skipped | 2335 passed, 2 skipped | +64 passed |
| design | 245 passed, 1 skipped | 245 passed, 1 skipped | 0 |
| workflow-python | 1052 passed, 3 skipped | 1053 passed, 3 skipped | +1 passed |
| pytest total | 3568 passed, 6 skipped | 3633 passed, 6 skipped | +65 passed |
...
65 tests are new, and each one is listed here.
...
| code | `tests/test_run_package_tests.py` | +6 | W0-01 discovery per group (code, design, workflow subfolders: 3); fix round: a `test-*.sh` under any test root runs and `tests/local/` does not (1), `TEST_ROOTS` are exactly the folders the pytest groups run (1), no shell test inside a nested worktree or clone runs (1) |
...
Reconciliation: code 23 probes + 6 + 7 + 28 = 64; design 0; workflow 1;
64 + 0 + 1 = 65 = 3633 − 3568. The 24 tests the baseline recorded as never

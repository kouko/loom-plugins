...
7. An instruction given partway through a change affects only the steps after it; a failure already produced before it still appears in the pull request.

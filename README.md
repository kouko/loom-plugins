...
| --- | --- | --- | --- |
| [`loom-design`](loom-design/) | 2.4.2 | 6 | Front of the flow: intent, specification, product principles, visual design, architecture. |
...
Version 2.4.2. Turns a rough idea into a confirmed intent and a risk-declared

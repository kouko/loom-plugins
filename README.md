...
| --- | --- | --- | --- |
| [`loom-design`](loom-design/) | 2.4.0 | 6 | Front of the flow: intent, specification, product principles, visual design, architecture. |
| [`loom-code`](loom-code/) | 3.16.0 | 7 | Engineering stations: plan, build, closing-review, ship, maintain. |
...
Version 2.4.0. Turns a rough idea into a confirmed intent and a risk-declared
...
Version 3.16.0. Five stations carry one change from plan to PR with
...
Version 5.3.3. Workflow tools used around the stations; all work without

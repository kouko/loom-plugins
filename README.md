...
| --- | --- | --- | --- |
| [`loom-design`](loom-design/) | 2.3.2 | 5 | Front of the flow: intent, specification, product principles, visual design. |
| [`loom-code`](loom-code/) | 3.14.1 | 7 | Engineering stations: plan, build, closing-review, ship, maintain. |
...
Version 2.3.2. Turns a rough idea into a confirmed intent and a risk-declared
...
Version 3.14.1. Five stations carry one change from plan to PR with
